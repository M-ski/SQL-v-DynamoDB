package com.mski.spring.jv.demo.jpa.service;

import com.mski.spring.jv.demo.jpa.model.Transaction;
import com.mski.spring.jv.demo.jpa.model.SoldItem;
...
import com.mski.spring.jv.demo.jpa.repository.StockRepository;
import com.mski.spring.jv.demo.jpa.repository.UserRepository;
...
public class DBPopulator {
    ...
    public void init() {
        ...
        stockRepository.save(new Stock(null, "Eggs", new HashSet<>(), BigDecimal.valueOf(1.35), 3));
        stockRepository.save(new Stock(null, "Sugar", new HashSet<>(), BigDecimal.valueOf(0.89), 7));
